...
<html lang="en">
  <head>
   ...
   <!-- <link rel="stylesheet" type="text/css" href="/assets/css/menu_sideslide.css">-->
    ...
    <!-- Nivo Lightbox -->
    <link rel="stylesheet" type="text/css" href="assets/css/nivoLightbox.css" >
    <!-- Animate -->
    ...
    <link rel="stylesheet" type="text/css" href="assets/css/responsive.css">
      ...
      <script type="text/javascript">
          ...
          ym(102979166, 'init', {clickmap:true, referrer: document.referrer, url: location.href, accurateTrackBounce:true, trackLinks:true});
      </script>
      <noscript><div><img src="https://mc.yandex.ru/watch/102979166" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
      <!-- /Yandex.Metrika counter -->
  ...
  <body>
        ...
        <div class="container">
          ...
          <div class="navbar-header">
            ...
            <a href="index.php" class="navbar-brand">
              <img src="/assets/img/logo60px1.png" alt="">
            </a>
          </div>
        ...
        <div class="row">
          <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
            <div class="img-thumb wow fadeInLeft" data-wow-delay="0.3s">
              <img class="img-fluid" src="/assets/img/about/about-1.png" alt="">
            </div>
          </div> 
          <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
          ...
          <div class="col-md-12">
            <div class="footer-text text-center wow fadeInDown" data-wow-delay="0.3s">
              <ul class="social-icon">
                <li>
                  <a class="facebook" target="_blank" href="https://www.facebook.com/grapharet/"><i class="icon-social-facebook"></i></a>
                </li>
                <li>
                  <a class="instagram" target="_blank" href="https://www.instagram.com/grapharet/"><i class="icon-social-instagram"></i></a>
                </li>
                <li>
                  <a class="google" target="_blank" href="mailto:grapharet@gmail.com"><i class="icon-envelope"></i></a>
                </li>
              </ul>
    ...
    <script type="text/javascript" src="assets/js/jquery.counterup.min.v1.js"></script>
